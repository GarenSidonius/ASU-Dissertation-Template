...
\else 									                % If xetex or luatex
  ...
  % Demo only
  %
  % Demonstrate how to use a local font.
  % To actually use, would probably want to find a font with a
  % bold typeface and if the dissertation contains math, use the 
  % font for math, as well.
  %
  % Font source (OFL licensed): https://fontesk.com/mels-font/
  %
  \setmainfont{Mels}[%
    Path          = fonts/mels/ ,
    Extension     = .otf ,
